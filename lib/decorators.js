 ...
 * @Description: 装饰器
 */
import { deleteLocal, deleteSeesion, initLocal, initSession, initStringify, setLocal, setSession, StringifyMap } from "./storage";
          ...
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              Object.keys(this).map(function (key) {
                ...
                if ((_StringifyMap$get = StringifyMap.get(contextName)) !== null && _StringifyMap$get !== void 0 && _StringifyMap$get.includes(key)) _this[key] = JSON.stringify(_this[key]);
              });
              store.dispatch({
